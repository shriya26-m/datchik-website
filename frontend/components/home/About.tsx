        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <p className="mt-8 text-lg text-gray-600 leading-8">
              Datchik Electronics Pvt. Ltd. specializes in innovative Lighting
              Solutions, Embedded Engineering, IoT-based Systems, Healthcare
              Electronics and Industrial Automation. We design, manufacture and
              deliver high-quality electronic products that empower businesses
