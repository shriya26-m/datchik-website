        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mt-6 grid gap-10 lg:grid-cols-2 lg:items-end">
            ...
            <p className="max-w-xl text-lg leading-8 text-slate-400 lg:pb-2">
              ...
              electronics, gas detection, smart solutions, wellness electronics
              and lighting.
            </p>
          </div>
        </div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="mb-16">
            ...
            <h2 className="mt-5 text-4xl font-semibold md:text-6xl">
              ...
              <span className="block text-slate-400">everyday needs.</span>
            </h2>
          </div>
          ...
          <div className="relative overflow-hidden rounded-[32px] bg-[#061426] px-8 py-16 text-white md:px-16">
            ...
            <div className="relative max-w-3xl">
              ...
              <p className="mt-6 text-lg leading-8 text-slate-400">
                Have a custom electronics requirement or a product idea? Our
                engineering team can help explore the right approach.
              </p>
